 ...
 *
 */
public class HourUpper extends Shape {
	private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(HourUpper.class);
 ...
 * @param blocNumber
 */
public HourUpper(int thickness, int width, int height, int blocNumber) {
...
public boolean checkActivation() {
	 if ( this.getTime().getHour() / ( 5 * this.getBlocNumber()) >=1   ) {
	    	return true;
	    }
	    else {
	    	return false;
